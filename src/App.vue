<template>
  <div id="app">
    ...
    <div class="container Section Section--light my-5 py-5">
      <div class="row">
        <div
          class="col-sm-8 col-md-6 col-lg-4 mx-sm-auto text-center text-lg-left"
        >
          <h2 class="Section-title Section-title--borderRed">Features</h2>
          <ul class="TextList">
            ...
            <li class="TextList-item">
              ...
              <p>
                Pomotroid is simple and straightforward, making it incredibly
                easy to use.
              </p>
            </li>
          </ul>
      ...
      <div class="container">
        ...
        <div class="row mb-3">
          <div class="col text-center">
            <h2 class="Section-title Section-title--borderBlue">Download</h2>
          </div>
        </div>
        <div class="row">
        ...
        <div class="row mt-5 py-5 Section">
          <div class="col text-center">
            ...
            <p>
              Found a bug or would like to suggest a new feature?
              <a
            ...
            <p>
              Feel free to explore the source or contribute via the
              <a
    ...
    <!-- footer -->
    <div class="container-fluid u-bg-navy">
        ...
        <div class="row">
          ...
          <div class="col-12 text-center">
            ...
            <a href="https://twitter.com/splode" target="_blank">
              ...
              >
                <path
                  d="M-429.2,256.3c-13.7,0-24.8,11.1-24.8,24.8c0,13.7,11.1,24.8,24.8,24.8c13.7,0,24.8-11.1,24.8-24.8
                ...
                c1.2-0.1,2.3-0.4,3.3-0.9C-416,273.7-417,274.7-418.1,275.5z"
                />
              </svg>
            </a>
          </div>
...
<script>
import appRounder from './components/Rounder'
...
export default {
  ...
  data() {
    return {
      downloadLinks: {
        windows:
          'https://github.com/Splode/pomotroid/releases/download/v0.6.1/Pomotroid-setup-0.6.1-64-bit.exe',
        mac:
          'https://github.com/Splode/pomotroid/releases/download/v0.6.1/Pomotroid-setup-0.6.1.dmg',
        linux:
          'https://github.com/Splode/pomotroid/releases/download/v0.6.1/Pomotroid-setup-0.6.1-x86_64.AppImage'
      },
      platforms: {
...
.Section-title--borderBlue {
  &::after {
    background-color: $colorBlue;
  }
}

.Section-title--borderGreen {
  &::after {
    background-color: $colorGreen;
  }
}

.Section-title--borderRed {
  &::after {
