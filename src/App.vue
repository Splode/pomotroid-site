...
export default {
  ...
  data () {
    return {
      downloadLinks: {
        windows: 'https://github.com/Splode/pomotroid/releases/download/v0.3.0/Pomotroid.Setup.0.3.0.exe',
        mac: 'https://github.com/Splode/pomotroid/releases/download/v0.3.0/Pomotroid-0.3.0.dmg',
        linux: 'https://github.com/Splode/pomotroid/releases/download/v0.3.0/pomotroid-0.3.0-x86_64.AppImage'
      },
      platforms: {
